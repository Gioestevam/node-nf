...
class XmlSignatureController {
    ...
    addSignatureToXml (xml, certificate, tagBeforeSignature, signatureId = null) {
        return new Promise ((resolve, reject) => {
            try {
                ...
                sig.addReference("//*[local-name(.)='" + tagBeforeSignature + "']", ["http://www.w3.org/2000/09/xmldsig#enveloped-signature", 'http://www.w3.org/2001/10/xml-exc-c14n#']);
